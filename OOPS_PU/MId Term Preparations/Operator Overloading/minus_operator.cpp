...
// this operator overloading function is defined outside class using scope resolution operator
marks marks ::operator-(marks &m) // using scope resolution operator
{
    marks ans;
    ans.internal_marks = internal_marks - m.internal_marks;
    ans.external_marks = external_marks - m.external_marks;
